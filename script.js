...
function randomGenerator () {
  ...
  if (randomNumber == userNumber) {
    ...
    document. getElementById('textbox'). value = ''
      ...
      // but if it the randomNumber was not equal to the userNumber, the program will say they were wrong
      document.getElementById('answer').innerHTML = 'You did not guess the right number :( Try guessing another number!'
      document. getElementById('textbox'). value = ''
    }
}
